...
var table = $(".tablasAdjuntosTallerArchivosGestion").DataTable({
   
  "ajax":"ajax/datatable-adjuntosArchivoGestion.ajax.php?perfilOculto="+perfilOculto,
  "deferRender": true,
  "retrieve": true,
  "processing": true,
   "scrollY": 450,
...
$('.tablasAdjuntosTallerArchivosGestion tbody').on( 'click', '.btnImprimirConstanciaArchivosGestion', function () {  
  
  var idAdjuntos =  $(this).attr("idAdjuntos");

  window.open("extensiones/tcpdf/pdf/ConstanciaArchivosGestion.php?id="+idAdjuntos, "_blank");
...
$(".tablasAdjuntosTallerArchivosGestion").on("click", ".btnEditarAdjuntosArchivosGestion", function(){
  ...
  $.ajax({
    url: "ajax/adjuntosArchivosGestion.ajax.php",
    method: "POST",
        data: datos,
        cache: false,
      contentType: false,
...
/*==================================================================
 ...
 $(".tablasAdjuntosTallerArchivosGestion").on("click", ".btnEliminarAdjuntosArchivosGestion", function(){
    ...
    type: 'warning',
        ...
        if (result.value) {
          ...
          window.location = "index.php?ruta=taller-archivosgestion&idAdjuntos="+idAdjuntos+"&nombre="+nombre+"&anios="+anios+"&taller="+taller;
