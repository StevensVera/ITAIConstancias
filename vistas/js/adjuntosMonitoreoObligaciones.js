...
var table = $(".tablasAdjuntosMonitoreoObligaciones").DataTable({
   
  "ajax":"ajax/datatable-adjuntosMonitoreoObligaciones.ajax.php?perfilOculto="+perfilOculto,
  "deferRender": true,
  "retrieve": true,
  "processing": true,
   "scrollY": 450,
...
$('.tablasAdjuntosMonitoreoObligaciones tbody').on( 'click', '.btnImprimirConstancia', function () {  
  
  var idAdjuntos =  $(this).attr("idAdjuntos");

  window.open("extensiones/tcpdf/pdf/ConstanciaObligaciones.php?id="+idAdjuntos, "_blank");
...
$(".tablasAdjuntosMonitoreoObligaciones").on("click", ".btnEditarAdjuntos", function(){
  ...
  $.ajax({
    url: "ajax/adjuntosMonitoreoObligaciones.ajax.php",
    method: "POST",
        data: datos,
        cache: false,
      contentType: false,
...
/*==================================================================
 ...
 $(".tablasAdjuntosMonitoreoObligaciones").on("click", ".btnEliminarAdjuntos", function(){
    ...
    type: 'warning',
        ...
        if (result.value) {
          ...
          window.location = "index.php?ruta=taller-monitoreo-obligaciones&idAdjuntos="+idAdjuntos+"&nombre="+nombre+"&correo="+correo+"&taller="+taller;
