...
var table = $(".tablasAdjuntosSensibilizacionManejoPNT").DataTable({
   
  "ajax":"ajax/datatable-adjuntosSensibilizacionManejoPNT.ajax.php?perfilOculto="+perfilOculto,
  "deferRender": true,
  "retrieve": true,
  "processing": true,
   "scrollY": 450,
...
$('.tablasAdjuntosSensibilizacionManejoPNT tbody').on( 'click', '.btnImprimirConstancia', function () {  
  
  var idAdjuntos =  $(this).attr("idAdjuntos");

  window.open("extensiones/tcpdf/pdf/ConstanciaSensibilizacionManejoPNT.php?id="+idAdjuntos, "_blank");
...
$(".tablasAdjuntosSensibilizacionManejoPNT").on("click", ".btnEditarAdjuntos", function(){
  ...
  $.ajax({
    url: "ajax/adjuntosSensibilizacionManejoPNT.ajax.php",
    method: "POST",
        data: datos,
        cache: false,
      contentType: false,
...
/*==================================================================
 ...
 $(".tablasAdjuntosSensibilizacionManejoPNT").on("click", ".btnEliminarAdjuntos", function(){

    var idAdjuntos = $(this).attr("idAdjuntos");
    var nombre = $(this).attr("nombre");
   // var anios = $(this).atrr("anios");
    ...
    type: 'warning',
        ...
        if (result.value) {
          ...
          window.location = "index.php?ruta=taller-sensibilizacion-manejo-PNT&idAdjuntos="+idAdjuntos+"&nombre="+nombre;
