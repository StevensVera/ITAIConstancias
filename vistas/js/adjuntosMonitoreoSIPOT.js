...
var table = $(".tablasAdjuntosMonitoreoSipot").DataTable({
   
  "ajax":"ajax/datatable-adjuntosMonitoreoSIPOT.ajax.php?perfilOculto="+perfilOculto,
  "deferRender": true,
  "retrieve": true,
  "processing": true,
   "scrollY": 450,
...
$('.tablasAdjuntosMonitoreoSipot tbody').on( 'click', '.btnImprimirConstancia', function () {  
  
  var idAdjuntos =  $(this).attr("idAdjuntos");

  window.open("extensiones/tcpdf/pdf/ConstanciaSipot.php?id="+idAdjuntos, "_blank");
...
$(".tablasAdjuntosMonitoreoSipot").on("click", ".btnEditarAdjuntos", function(){
  ...
  $.ajax({
    url: "ajax/adjuntosMonitoreo.ajax.php",
    method: "POST",
        data: datos,
        cache: false,
      contentType: false,
...
/*==================================================================
 ...
 $(".tablasAdjuntosMonitoreoSipot").on("click", ".btnEliminarAdjuntos", function(){
    ...
    type: 'warning',
        ...
        if (result.value) {
          ...
          window.location = "index.php?ruta=taller-monitoreo-sipot&idAdjuntos="+idAdjuntos+"&nombre="+nombre+"&correo="+correo+"&taller="+taller;
