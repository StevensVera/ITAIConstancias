...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    Constancias Taller de Datos Personales - "	Generalidades en Materia de Protección de Datos..."
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Constancias Taller de Datos Personales</li>
    ...
    if($_SESSION["Perfil"] == "Administrador"){
     ...
     ?>
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablasAdjuntosDatosPersonales" width="100%">
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
   ...
   <div class="modal-footer">
    ...
    <?php 
      ...
      $CrearAdjuntos = new ControladorAdjuntosPersonalesGeneralidades();
      $CrearAdjuntos -> ctrCrearAdjuntosPersonalesGeneralidades();
      /*
...
<div id="modalEditarAdjuntos" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
    ...
    <?php 
      ...
      $editarAdjuntos = new ControladorAdjuntosPersonalesGeneralidades();
      $editarAdjuntos -> ctrEditarAdjuntosPersonalesGeneralidades();
    /* 
    ...
    */
    ...
    <?php 
      ...
      $EliminarAdjuntos = new ControladorAdjuntosPersonalesGeneralidades();
      $EliminarAdjuntos -> ctrBorrarAdjuntosPersonalesGeneralidades();
        /*
