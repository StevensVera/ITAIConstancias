...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Constancias Taller de Monitoreo - "Obligaciones de Transparencia y Llenado de Formatos"
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Constancias de Taller de Obligaciones</li>
    ...
    if($_SESSION["Perfil"] == "Administrador"){
     ...
     ?>
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablasAdjuntosMonitoreoObligaciones" width="100%">
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
   ...
   <div class="modal-footer">
    ...
    <?php 
      ...
      $CrearAdjuntos -> ctrCrearAdjuntosMonitoreoObligaciones();
      /*
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
    ...
    */
    ...
    <?php 
      ...
      $EliminarAdjuntos -> ctrBorrarAdjuntosMonitoreoObligaciones();
        /*
