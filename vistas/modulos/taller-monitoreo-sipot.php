...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Constancias de Taller de Monitoreo - "Funcionalidades y Manejo del Sistema de Portales..."
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Constancias de Taller de Monitoreo</li>
    ...
    if($_SESSION["Perfil"] == "Administrador"){
     ...
     ?>
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablasAdjuntosMonitoreoSipot" width="100%">
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
   ...
   <div class="modal-footer">
    ...
    <?php 
      ...
      $CrearAdjuntos = new ControladorAdjuntosMonitoreo();
      $CrearAdjuntos -> ctrCrearAdjuntosMonitoreoSIPOT();
      /*
...
<div id="modalEditarAdjuntos" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg" style="width: 60%">
    ...
    <?php 
      ...
      $editarAdjuntos = new ControladorAdjuntosMonitoreo();
      $editarAdjuntos -> ctrEditarAdjuntosMonitoreoSIPOT();
    /* 
    ...
    */
    ...
    <?php 
      ...
      $EliminarAdjuntos = new ControladorAdjuntosMonitoreo();
      $EliminarAdjuntos -> ctrBorrarAdjuntosMonitoreoSIPOT();
        /*
