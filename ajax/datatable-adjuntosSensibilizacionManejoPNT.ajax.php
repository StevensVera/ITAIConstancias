...
public function mostrarTablaAdjunto(){
	...
	$adjunto = ControladorAdjuntosSensibilizacionManejoPNT::ctrMostrarAdjuntosSensibilizacionManejoPNT($item,$valor,$orden);
...
=============================================*/ 
$activar = new TablaAdjuntos();
$activar -> mostrarTablaAdjunto();
